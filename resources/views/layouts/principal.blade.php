    ...
    <div id="app" style="background-color: #a3bcc9;" >
        ...
        <div class="container " style="background-color: #274453;">
            <div class="row">
                ...
                <div class="col"><a href="{{url('role')}}" style="color: #ffffff;"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

    ...
    <div id="app" style="background-color: #a3bcc9;" >
        ...
        <div class="container" style="background-color: #274453;">
            ...
            <div class="col-xl-1"> 
              ...
              <a href="{{url('principal')}}" style="color: rgb(255, 255, 255);"> <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-house-door-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container" style="background-color: #274453;">
            <div class="row">
                <div class="col"><input class="form-control-plaintext" type="text" value="ADMINISTRADOR" readonly="" style="font-size: 20px; color: rgb(255, 255, 255);"></div>
            </div>
        </div>
        ...
        <div class="container" style="background-color: #274453;">
            <div class="row">
                ...
                <div class="col"><a href="{{url('materia')}}" style="color: rgb(255, 255, 255);"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-newspaper" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col"><a href="{{url('user')}}" style="color: rgb(255, 255, 255);"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-person-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"/>
                    <path fill-rule="evenodd" d="M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                    <path fill-rule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"/>
                  </svg> USUARIOS</a></div>
                <div class="col"><a href="{{url('role')}}" style="color: rgb(255, 255, 255);"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col"><a href="{{url('asignacion')}}" style="color: rgb(255, 255, 255);"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-list-task" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M2 2.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5V3a.5.5 0 0 0-.5-.5H2zM3 3H2v1h1V3z"/>
                    <path d="M5 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM5.5 7a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 4a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9z"/>
                    <path fill-rule="evenodd" d="M1.5 7a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H2a.5.5 0 0 1-.5-.5V7zM2 7h1v1H2V7zm0 3.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5H2zm1 .5H2v1h1v-1z"/>
                  </svg> ASIGNACIONES</a></div>
                <div class="col"><a href="{{url('carrera')}}" style="color: rgb(255, 255, 255);"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-book-half" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col"><a href="{{url('gestion')}}" style="color: rgb(255, 255, 255);"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-calendar-event-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

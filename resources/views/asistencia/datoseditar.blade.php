    ...
    <div class="container" >
        <div class="row justify-content-center" >
            <div class="col-md-8">
                ...
                <form action="{{url('asistencia/actualizar/'.$llave)}}"  class= "form-horizontal" style="font-family: Arial;color: rgb(0, 0, 0);" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <input class="form-control" type="string" name="llave" id="llave" value="{{$llave}}" required hidden>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="contenido" id="contenido" value="{{$contenido}}" required>
                    </div>  
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="observaciones" id="observaciones" value="{{$observaciones}}" required>
                    </div>  
                
                    <div class="form-group">
                        <label for="firma" class="control-label">Firma</label>
                        <input class="form-control" type="text" name="firma" id="firma" value="{{$firma}}" required>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="grabacion" id="grabacion" value="{{$grabacion}}" required>
                    </div> 
                    @endrole
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="tarea" id="tarea" value="{{$tarea}}" required>
                    </div> 
                    @endrole
